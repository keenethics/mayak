...
export function Header() {
  ...
  const fullScreenSize = 'w-dvw h-dvh';
  ...
  return (
    <nav
      className={cn(
        flexBetween,
        'fixed left-0 top-0 z-10 w-full border-b-[1px] border-b-gray-300  bg-primary-100 px-4 py-4 md:static md:px-20',
      )}
    >
      ...
      <div
        className={cn(
          fullScreenSize,
          'absolute left-[100dvw] top-0 flex h-dvh flex-col bg-other-black transition-all duration-300 md:hidden',
          isMenuOpen && 'left-0',
        )}
      >
