...
export function NoInfoToShow({ text }) {
  return (
    <div className="no-wrap flex h-[250px] w-full flex-shrink-0 flex-col items-center justify-center gap-[15px] bg-gray-100 md:h-[300px] md:gap-[40px] lg:h-[400px] lg:gap-[40px]">
